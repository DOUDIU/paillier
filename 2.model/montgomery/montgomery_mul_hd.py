...
if __name__=='__main__':
    x = 0xa95e2ca898b2439d6617009764404ec6670824178bf8160622a5c506c12d0df9
    y = 0x2311a5d7e49bc3b317515375619f677950c61ad163b88f6e1e4668b5d6bbca5c
    z = 0x084c46795b371c7736e30631890f8f1b0f0a7e671cfd1a3d1589b61189feb04cb
    z = z >> 128
    result = x + y + z
    print('result:\n0x{:x}\n'.format(result))
